...
import { Archive, Chats, House, List, SignOut, Users } from "@phosphor-icons/react";
...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      ...
      <body className={`${gabarito.className} antialiased bg-color-dark scroll-smooth`}>
        <SessionProvider>
