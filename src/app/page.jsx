...
import UserListHome from "@/components/Dashboard/UserListHome";
import CollectionListHome from "@/components/Dashboard/CollectionListHome";
import CommentsListHome from "@/components/Dashboard/CommentsListHome";
  ...
  return (
    <main className="pt-8 pl-4 pr-6 -ml-0">
      <section className="mb-8 text-color-primary">
        <Image src="./just-a-logo.svg" alt="..." width={200} height={200} className="rounded-full h-28" />
        <h1 className="mb-4 text-2xl font-bold text-color-secondary animate-fadeIn">
